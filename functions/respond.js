...
function page(title, msg, color, tag) {
...
.tag{display:inline-block;border-radius:980px;background:${color}26;color:${color};padding:7px 16px;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;margin:0 auto 18px}
...
<div class="card"><div class="tag">${tag}</div><h1>${title}</h1><p>${msg}</p></div>
</body></html>`;
}
